...
\begin{samepage}
	...
	\begin{itemize}
		...
		\item Guided student athletes through drills that focused on using the proper techniques to keep them safe
		\item Tutored students in math focusing on problem solving skills. 
	\end{itemize}
\end{samepage}
\end{itemize}
...
\begin{itemize} \itemsep -2pt % Reduce space between items
	\item   M. Murphy, [et al. including \textbf{J. Bane}], "Measurement of the cross sections for inclusive electron scattering in the E12-14-012 experiment at Jefferson Lab," Phys. Rev. C 100, 054606 (2019)
	...
	\item R. Cruz-Torres, [et al. including \textbf{J. Bane}], ``Comparing proton momentum distributions in A=3 nuclei via $^3$He and $^3H$(e,$e^\prime$p) measurements," Physics Letters B 797 (2019) 134890
...
\begin{multicols}{2}
	...
	{\noindent\bf{Evan McClellan}}, Assistant Professor of Physics\\ Pensacola State College \\
	vanlellan@gmail.com\\
